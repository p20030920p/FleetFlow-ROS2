...
def generate_launch_description():
    ...
    core = [
        ...
        Node(package=PKG, executable="factory_manager", name="factory_manager", output="screen",
             parameters=[dict(num_materials=LaunchConfiguration("num_materials"),
                              ...
                              stale_task_timeout_s=LaunchConfiguration("stale_task_timeout"),
                              advance_first=LaunchConfiguration("advance_first"),
                              use_sim_time=use_sim_time)]),
        Node(package=PKG, executable="traffic_manager", name="traffic_manager", output="screen",
             ...
             parameters=[dict(use_sim_time=use_sim_time,
                              ...
                              stall_horizon_s=LaunchConfiguration("stall_horizon"),
                              escape_election=LaunchConfiguration("escape_election"),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("stale_task_timeout", default_value="180.0"),
